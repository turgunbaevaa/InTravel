...
class TourDetailsView: UIView {
    ...
    private let imageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "placeholder_image") // Replace 
        return imageView
    }()
    ...
    private let remarksLabel: UILabel = {
        ...
        label.textColor = .white
        label.numberOfLines = 0 // Allow multiple lines for long remarks
        return label
    }()
    ...
    func configure(with tour: Tour) {
        ...
        imageView.image = UIImage(named: "tour_image_placeholder") // Replace
    }
